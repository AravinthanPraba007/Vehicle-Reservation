...
import com.pro.vechileSystem.controller.UserController;
import com.pro.vechileSystem.security.AppUserDetailsService;
import com.pro.vechileSystem.security.JwtAuthorizationFilter;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity httpSecurity) throws Exception {
		...
		httpSecurity.csrf().disable().httpBasic().and().authorizeRequests()
				...
				.antMatchers("/vechile").permitAll().antMatchers("/authenticate").permitAll().anyRequest()
